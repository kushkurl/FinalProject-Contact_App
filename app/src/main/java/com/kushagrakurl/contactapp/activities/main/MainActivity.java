package com.kushagrakurl.contactapp.activities.main;
...
import com.kushagrakurl.contactapp.fragments.contacts.ContactsFragment;
import com.kushagrakurl.contactapp.fragments.addedit.AddEditFragment;
...
public class MainActivity extends AppCompatActivity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(savedInstanceState == null && findViewById(R.id.fragmentContainer) != null) {
			...
			transaction.add(R.id.fragmentContainer, mContactsFragment , null);
