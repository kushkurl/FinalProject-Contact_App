package com.kushagrakurl.contactapp.adapters;
...
public class ContactsAdapter extends RecyclerView.Adapter<ContactsAdapter.ViewHolder> {
	...
	public void onBindViewHolder(@NonNull ContactsAdapter.ViewHolder viewHolder, int position) {
		...
		// get the contact id
		@SuppressLint("Range") long contactID = cursor.getLong(cursor.getColumnIndex(Contact.COLUMN_ID));
		LogWrapper.d("Contact ID = " + contactID);
		viewHolder.setContactID(contactID);
		
		// get the contact name
		@SuppressLint("Range") String contactName = cursor.getString(cursor.getColumnIndex(Contact.COLUMN_NAME));
